...
from teacher_dashboard.util import classroom
...
class TestClassroom(unittest.TestCase):
    ...
    @patch('teacher_dashboard.util.classroom.api_post')
    ...
    @patch('teacher_dashboard.util.classroom.api_get')
    @patch('teacher_dashboard.util.classroom.json')
